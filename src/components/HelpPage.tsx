...
import { ArrowRight, Apple, BookOpen, GraduationCap, MessageSquare, Smartphone, Zap } from "lucide-react";
    ...
    <div className="mx-auto max-w-2xl px-5 pt-8 pb-16 md:pt-12">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <div>
            <div className="font-semibold text-ink-50">Sandbox</div>
            <div className="text-xs text-ink-300">A live harness — chat with any frontier model.</div>
          </div>
        </Link>
        <Link
          to="/pocket"
